...
var messages = map[string]map[Lang]string{
	...
	// ---- Tournaments ----------------------------------------------------
	"nav.tournaments":       {DE: "Turniere", EN: "Tournaments"},
	"tourn.title":           {DE: "Turniere – %s", EN: "Tournaments – %s"},
	"tourn.new":             {DE: "Neues Turnier", EN: "New tournament"},
	"tourn.none":            {DE: "Noch keine Turniere.", EN: "No tournaments yet."},
	"tourn.name":            {DE: "Name", EN: "Name"},
	"tourn.name_ph":         {DE: "z.B. Weihnachtsturnier", EN: "e.g. Christmas tournament"},
	"tourn.format":          {DE: "Format", EN: "Format"},
	"tourn.format.rr":       {DE: "Jeder gegen jeden", EN: "Round robin"},
	"tourn.format.mm":       {DE: "McMahon", EN: "McMahon"},
	"tourn.board":           {DE: "Brett", EN: "Board"},
	"tourn.rounds":          {DE: "Runden", EN: "Rounds"},
	"tourn.rounds_hint":     {DE: "0 = automatisch (nur McMahon)", EN: "0 = automatic (McMahon only)"},
	"tourn.handicap":        {DE: "Mit Vorgabe (Handicap)", EN: "With handicap"},
	"tourn.handicap_hint":   {DE: "Schwächere Spieler bekommen Steine – dann kann jeder gewinnen.", EN: "Weaker players get stones – then anyone can win."},
	"tourn.handicap_on":     {DE: "mit Vorgabe", EN: "with handicap"},
	"tourn.handicap_off":    {DE: "ebenbürtig", EN: "even games"},
	"tourn.create":          {DE: "Turnier anlegen", EN: "Create tournament"},
	"tourn.status.setup":    {DE: "Vorbereitung", EN: "Setup"},
	"tourn.status.running":  {DE: "läuft", EN: "running"},
	"tourn.status.finished": {DE: "beendet", EN: "finished"},
	"tourn.pick_players":    {DE: "Spieler auswählen", EN: "Select players"},
	"tourn.pick_hint":       {DE: "Tippe die Spieler an, die mitspielen sollen.", EN: "Tap the players who take part."},
	"tourn.start":           {DE: "Turnier starten", EN: "Start tournament"},
	"tourn.standings":       {DE: "Tabelle", EN: "Standings"},
	"tourn.rounds_heading":  {DE: "Runden", EN: "Rounds"},
	"tourn.round":           {DE: "Runde %d", EN: "Round %d"},
	"tourn.bye":             {DE: "spielfrei (Punkt geschenkt)", EN: "bye (free point)"},
	"tourn.vs":              {DE: "gegen", EN: "vs"},
	"tourn.vorgabe_label":   {DE: "Vorgabe", EN: "Handicap"},
	"tourn.black_wins":      {DE: "Schwarz ⚫", EN: "Black ⚫"},
	"tourn.white_wins":      {DE: "Weiß ⚪", EN: "White ⚪"},
	"tourn.next_round":      {DE: "Nächste Runde auslosen", EN: "Draw next round"},
	"tourn.finish":          {DE: "Turnier beenden", EN: "Finish tournament"},
	"tourn.th.place":        {DE: "Platz", EN: "Place"},
	"tourn.th.score":        {DE: "Punkte", EN: "Points"},
	"tourn.th.wins":         {DE: "Siege", EN: "Wins"},
	"tourn.th.sos":          {DE: "SOS", EN: "SOS"},
	"tourn.finished_banner": {DE: "Turnier beendet – Sieger: %s 🏆", EN: "Tournament finished – winner: %s 🏆"},
	"tourn.err.start":       {DE: "Turnier konnte nicht gestartet werden (mindestens 2 Spieler nötig).", EN: "Could not start the tournament (at least 2 players needed)."},
}
