...
- **MCP-Clients** sind KI-Chats wie Claude.ai. Sie sprechen das MCP-Protokoll, authentifizieren sich beim ersten Verbinden gegen unsere App, und können dann im Namen der angemeldeten Admins arbeiten.
...
- **Spielstärke** — wie der GoR-Wert funktioniert und wie wir ihn fortschreiben.
- **Vorgabe & Komi** — wie wir aus der Spielstärken­differenz eine Steine-/Komi-Empfehlung machen.
- **MCP-Server** — wie der Admin-Chat angeschlossen wird und welche Tools es gibt.
- **Tablet-Workflow** — wie der Wizard durchgespielt wird.
- **Authentifizierung** — wie OIDC und OAuth zusammenspielen.
- **Deployment** — wie der Code in den Cluster kommt.
